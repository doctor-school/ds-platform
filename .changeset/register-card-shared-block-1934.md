...
The block also carries the 003 EARS-38 show-password labels down to `<PasswordField>` (`copy.passwordRevealLabels`), so the reveal control #1663 shipped reaches both doors through the shared field rather than a per-host copy.
