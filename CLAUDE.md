...
Работа заблокирована ТОЛЬКО действием владельца → последняя видимая строка хода: `⏸ ЖДУ ВАС: <одно действие>; после него продолжу автономно`; поллер/wakeup — после неё, не вместо. Развилки владельцу решаются ИНТЕРАКТИВНО (owner 2026-08-24): ровно ОДНА развилка на сообщение — продуктовая сущность простым русским · почему важно · 2–3 варианта с рекомендацией; дословный ответ записывается в артефакт, затем следующая. Две+ развилки списком или счётчик «осталось N решений» в статусе — нарушение. Каждый вопрос самодостаточен, без жаргона и отсылок к отчётам прошлых сессий.
