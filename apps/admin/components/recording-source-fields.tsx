...
/**
 * The recording SOURCE triple — provider, embed reference, poster, duration —
 * as one component (014 EARS-1 / EARS-24).
 *
 ...
 * hint, the poster guidance and the seconds cap drift apart between the dialog an
 * operator uses after the эфир and the form they use to author one that predates
 * the platform (AGENTS.md §6 — reuse before invention).
 *
      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem>
            ...
            <FormMessage>{t("recordings.fields.posterRefHint")}</FormMessage>
          </FormItem>
        )}
      />
      <FormField
        ...
        render={({ field }) => (
          <FormItem>
            ...
            <FormMessage>{t("recordings.fields.durationSecHint")}</FormMessage>
          </FormItem>
        )}
      />
    </>
