...
- Updated dependencies [[`390c917`](https://github.com/doctor-school/ds-platform/commit/390c9178288cc3737efbad87ba9ee1dbe5289d6b), [`640a608`](https://github.com/doctor-school/ds-platform/commit/640a60846ef16544d4bf4e61d4d22db6e6d53ba1)]:
  - @ds/db@3.1.0
...
- [#1891](https://github.com/doctor-school/ds-platform/pull/1891) [`5688b56`](https://github.com/doctor-school/ds-platform/commit/5688b564e2b4850a8a0fd81813dde210e99fd827) Thanks [@sidorovanthon](https://github.com/sidorovanthon)! - 012 EARS-24 — the event speaker line-up has a single source. `event_experts`
...
- [#1903](https://github.com/doctor-school/ds-platform/pull/1903) [`659c615`](https://github.com/doctor-school/ds-platform/commit/659c615c9b7e487afaf479b4c9aa76122c10a3ef) Thanks [@sidorovanthon](https://github.com/sidorovanthon)! - 014 EARS-29 — a `recordings:backfill` operator CLI that attaches and publishes the
  missing recordings of platform-born эфиры through the ordinary AttachRecording +
  PublishRecording commands, with a dry-run and a per-row report.

- [#1899](https://github.com/doctor-school/ds-platform/pull/1899) [`7039a26`](https://github.com/doctor-school/ds-platform/commit/7039a263e4c22cefbb6f1e794da3eaa3f95cfe3d) Thanks [@sidorovanthon](https://github.com/sidorovanthon)! - `POST /v1/admin/legacy-broadcasts` now requires a canonical `Idempotency-Key` (014 EARS-17.1): a retried create replays the original 201 instead of authoring a second эфир
...
- [#1805](https://github.com/doctor-school/ds-platform/pull/1805) [`28b7850`](https://github.com/doctor-school/ds-platform/commit/28b785045c9ce2a7d96ce65242ac635ddf52d197) Thanks [@sidorovanthon](https://github.com/sidorovanthon)! - 019 LD-2 — «показать ещё» is offered only when something lies beyond the
...
- [#1831](https://github.com/doctor-school/ds-platform/pull/1831) [`17d7ba8`](https://github.com/doctor-school/ds-platform/commit/17d7ba861219bee75220ccb1a652e2b0ee233647) Thanks [@sidorovanthon](https://github.com/sidorovanthon)! - legacy `in_archive` эфир recording is playable on the public page; wrong-machine lifecycle refusals name the real command/target
...
- [#1898](https://github.com/doctor-school/ds-platform/pull/1898) [`a97edc2`](https://github.com/doctor-school/ds-platform/commit/a97edc21ed65c0e2f45523f3e5b0d361c783c7f8) Thanks [@sidorovanthon](https://github.com/sidorovanthon)! - 014 EARS-11 — `GET /v1/public/events` paged on a cursor encoded from the
  ...
  `public-event-cursor` module ([#1294](https://github.com/doctor-school/ds-platform/issues/1294)): the cursor carries the instant exactly as
...
- [#2043](https://github.com/doctor-school/ds-platform/pull/2043) [`3356918`](https://github.com/doctor-school/ds-platform/commit/335691832c6479ab2019da6b35864bfeb07cdffd) Thanks [@sidorovanthon](https://github.com/sidorovanthon)! - 012 EARS-20 ([#1607](https://github.com/doctor-school/ds-platform/issues/1607)): migration 0028 carries the reviewed per-id Expert name mapping. Its coverage guard now fails closed on a retained `experts` row outside the reviewed mapping instead of on any retained row at all, and backfills `family_name` / `given_name` / `patronymic` for the covered rows before the structured-name constraint is added. A mapping id absent from the table is not an error. No parser: 012 §LD-10 makes existing Expert names reviewed data, never parsed input.

- [#1947](https://github.com/doctor-school/ds-platform/pull/1947) [`1bd60a0`](https://github.com/doctor-school/ds-platform/commit/1bd60a0bbfbd64663ef490bd20450496d753ed94) Thanks [@sidorovanthon](https://github.com/sidorovanthon)! - taxonomy relation creates map a concurrent unique-constraint loser to 409 instead of 500 (012 EARS-17 sweep)

- [#1885](https://github.com/doctor-school/ds-platform/pull/1885) [`9e0fdff`](https://github.com/doctor-school/ds-platform/commit/9e0fdfff40b62e6a1fec30173f3eed8942d520a0) Thanks [@sidorovanthon](https://github.com/sidorovanthon)! - 012 EARS-12 — fix a non-terminating public page loop on the event-ordered
...
- [#1736](https://github.com/doctor-school/ds-platform/pull/1736) [`ec6b4f8`](https://github.com/doctor-school/ds-platform/commit/ec6b4f86d0f6b4b0c93ae55dc16d1fcb43c6b8c4) Thanks [@sidorovanthon](https://github.com/sidorovanthon)! - fix(1655): resolve the real client IP behind the reverse-proxy chain
...
- Updated dependencies [[`f81468d`](https://github.com/doctor-school/ds-platform/commit/f81468d52165898f8c7b1f0de553917f4d0ed18b), [`1d1be8f`](https://github.com/doctor-school/ds-platform/commit/1d1be8f5f4787214ce740eb46f4c6976112ab647), [`2226016`](https://github.com/doctor-school/ds-platform/commit/222601672d17079eb06914a34dd894b6993dc4c3), [`d388a70`](https://github.com/doctor-school/ds-platform/commit/d388a70455b8c04eb9fe69fbb534da2765fe25a5)]:
  - @ds/db@0.10.0
  - @ds/schemas@3.2.0
...
- [#1201](https://github.com/doctor-school/ds-platform/pull/1201) [`2114512`](https://github.com/doctor-school/ds-platform/commit/2114512b17822587280804a012b875e1512d4343) Thanks [@sidorovanthon](https://github.com/sidorovanthon)! - 011 EARS-1/2/3/10 — dedicated `__Host-ds_admin_session` tier, `role → mfa_required` policy, pending-auth.
...
- [#1214](https://github.com/doctor-school/ds-platform/pull/1214) [`823f0d3`](https://github.com/doctor-school/ds-platform/commit/823f0d319994754e6eb24092508ff5c76189cb88) Thanks [@sidorovanthon](https://github.com/sidorovanthon)! - 011 EARS-9/11/13 ([#1193](https://github.com/doctor-school/ds-platform/issues/1193)) — the admin tier's audit trail and endpoint-authz floor are now verified end to end, and the operator factor-removal endpoint `DELETE /v1/admin/users/:id/mfa` ships with them.
...
- [#1150](https://github.com/doctor-school/ds-platform/pull/1150) [`119d2d1`](https://github.com/doctor-school/ds-platform/commit/119d2d1c19f8a2e46cd1ed70970dda7aba5acc70) Thanks [@sidorovanthon](https://github.com/sidorovanthon)! - 003 EARS-34/35: enumeration-safe recovery for email-unverified accounts ([#1131](https://github.com/doctor-school/ds-platform/issues/1131)).
...
- [#1077](https://github.com/doctor-school/ds-platform/pull/1077) [`961a532`](https://github.com/doctor-school/ds-platform/commit/961a532995eb1568446f1973c478b24fe557fef5) Thanks [@sidorovanthon](https://github.com/sidorovanthon)! - EARS-13 auth rate-limit ceilings become env-overridable per var (`RATE_LIMIT_PER_USER_15MIN` / `RATE_LIMIT_PER_IP_15MIN` / `RATE_LIMIT_PER_ASN_1H`) for an ops / load-test window ([#1076](https://github.com/doctor-school/ds-platform/issues/1076)). Inert additive knob: unset ⇒ the byte-identical EARS-13 defaults (per-user 10/15 min, per-IP 20/15 min, per-ASN 100/h); a malformed / ≤0 / non-integer value is ignored with a loud warn and the default kept — never an unlimited state, never a boot crash.

## 0.19.0

### Minor Changes

- [#1056](https://github.com/doctor-school/ds-platform/pull/1056) [`073b6f3`](https://github.com/doctor-school/ds-platform/commit/073b6f39a2c23d258cbbe991fc8c61d9d774bec4) Thanks [@sidorovanthon](https://github.com/sidorovanthon)! - Email-verify and password-reset codes now ride Zitadel's `returnCode` and are delivered by the BFF mailer as branded, Russian, code-only, fully link-free emails (003 EARS-29): the code leads the subject, the body shows it as one unbroken enlarged token with an explicit 1-hour expiry line, and the mail carries zero links. Zitadel keeps full code authority (generate/store/expire/verify) but sends nothing for these types; the transiting code is scrubbed from every egress — logs, traces, error reports, provider echoes, audit ledger (EARS-30). The Zitadel-side `verifyemail`/`passwordreset` message-text overrides and the `urlTemplate`/`sendLink` send hops are retired.

- [#1057](https://github.com/doctor-school/ds-platform/pull/1057) [`ee58331`](https://github.com/doctor-school/ds-platform/commit/ee5833198e6413c67df4ad5114ee76fb2966dada) Thanks [@sidorovanthon](https://github.com/sidorovanthon)! - BFF mailer transport gains the mail.ru→Resend failover chain (003 EARS-31, design §14.3): one channel switch per send on a rate-limit/availability rejection (mail.ru 451, Resend 429, any 4xx/5xx/connection failure), never a same-channel retry, delivered only on a provider 2xx; both channels failing is fail-closed with both provider codes while the enumeration-safe API response stays unchanged (never a 500). Every failover and relay failure emits a structured log, a `bff_mailer_relay_events_total{event,provider,code}` Prometheus counter, and a GlitchTip event (EARS-32). New Resend adapter is configured via `RESEND_API_KEY` (failover-only per the recorded 152-ФЗ posture, design §14.6); the Mailpit sink path ([#209](https://github.com/doctor-school/ds-platform/issues/209)) never fails over to a real provider.
...
- [#1074](https://github.com/doctor-school/ds-platform/pull/1074) [`bdf9ffd`](https://github.com/doctor-school/ds-platform/commit/bdf9ffd1977c12e71b10d5d2b1c5b678edfbcce4) Thanks [@sidorovanthon](https://github.com/sidorovanthon)! - BFF gains a recipient-scoped, env-gated synthetic-send suppression seam for the [#873](https://github.com/doctor-school/ds-platform/issues/873) load-test (003 EARS-33, design §14.8). With `LOADTEST_SUPPRESS_SYNTHETIC` ON, a transactional email or SMS addressed to a reserved synthetic recipient (email domain suffix `LOADTEST_SYNTHETIC_DOMAIN`, default `@loadtest.invalid`; SMS number prefix `LOADTEST_SYNTHETIC_MSISDN_PREFIX`, default `+999`) is dropped at the single mailer/SMS send point BEFORE the relay/provider hop — after the identical request-shape pipeline the load test must exercise (enumeration-safe wrapper, `register-notice-throttle`, artifact composition / EARS-14 budget) — and counted on `mailer_synthetic_suppressed_total{channel}` with a loud structured log line, so zero real send leaves the box. Three-state matrix, fail-closed on the toggle: OFF (default → the seam is fully inert) sends every recipient normally; ON + tagged → suppressed; ON + untagged → normal. It never touches the global `EMAIL_DELIVERY_MODE` / `SMS_DELIVERY_MODE`. Backend-only (no UI). [#1068](https://github.com/doctor-school/ds-platform/issues/1068) blocks [#873](https://github.com/doctor-school/ds-platform/issues/873) phase 2.

### Patch Changes

- [#1039](https://github.com/doctor-school/ds-platform/pull/1039) [`9685fd6`](https://github.com/doctor-school/ds-platform/commit/9685fd6dc20f56e0a18be10e2a67418aeadf8fb6) Thanks [@sidorovanthon](https://github.com/sidorovanthon)! - fix(auth): the session-self surface (session/refresh/logout) admits a `platform_admin`-only principal, not just `doctor_guest` — an operator provisioned admin-only is no longer locked out of (and orphaning sessions on) the admin app ([#1038](https://github.com/doctor-school/ds-platform/issues/1038)).
