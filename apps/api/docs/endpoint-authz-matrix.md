...
| GET /v1/me/events                      | authenticated | doctor_guest   | fast-path  | —            | false   | none        | EARS-6, EARS-10          |
...
| POST /v1/events/:idOrSlug/registration | authenticated | doctor_guest   | fast-path  | —            | false   | low-stakes  | EARS-1, EARS-3, EARS-10  |
