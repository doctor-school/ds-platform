...
ALTER TABLE "registrations" ADD COLUMN "confirmation_mail_at" timestamp with time zone;--> statement-breakpoint
ALTER TABLE "registrations" ADD COLUMN "account_created_by_intake" boolean;