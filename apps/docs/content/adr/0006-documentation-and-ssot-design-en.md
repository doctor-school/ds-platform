...
4. EARS-ID ↔ Vitest linkage convention (resolved): flat numbering — `it('EARS-N: ...', ...)`; nested `N.M` only when a single handler carries multiple shall-clauses. Reference spec: `001-api-bootstrap-health`.
