...
| CI runner              | BBM self-hosted pool `bbm-ci` for the 36 eligible `ci.yml` jobs; GitHub-hosted `ubuntu-latest` keep-set (docker/browser/egress-bound jobs, guards, release/bot workflows) | §2.8                        |
