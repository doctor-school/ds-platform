...
| **OQ-2.** Congress 2027 — the scope of the first end-to-end slice on the platform (**Q-10**, **CON-9**, REQ-79…86)                                           | `TODO(Product Lead)`             | Before registration opens (November 2026)                         |
