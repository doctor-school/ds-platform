...
description: "Procedural skill (dispatch): subagent verifies the 13-item iteration-end checklist and returns a PASS/BLOCKED verdict. Primary enforcement for F-15; item 12 enforces F-22 (vertical-slice DoD)."
...
You are a verification subagent. Your sole job is to verify the 13-item iteration-end checklist and return a structured verdict. You do not fix anything; you do not push; you do not merge. You produce a report.
...
VERDICT: <N> of 13 — <PASS | BLOCKED on #X[, #Y]>
```
