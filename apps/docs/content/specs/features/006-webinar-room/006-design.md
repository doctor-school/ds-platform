...
stateDiagram-v2
  ...
  Suspected --> Unverified: advisory time box elapsed — banner auto-dismisses, gesture-gated restart persists
  Unverified --> Playing: «Перезапустить плеер» OR playing signal (recovery)
  ...
  note right of Unverified
    Advisory withdrawn after
    PLAYER_ADVISORY_TIMEBOX_MS;
    embed visible, no banner,
