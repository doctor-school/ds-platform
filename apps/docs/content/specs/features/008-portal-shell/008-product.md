...
- The **persistent app-shell header** is the vendored-canvas header present across **all** portal screens — [`design-source/account-my-events.dc.html`](../../../../../../design-source/account-my-events.dc.html), [`design-source/events-feed.dc.html`](../../../../../../design-source/events-feed.dc.html), [`design-source/event-page.dc.html`](../../../../../../design-source/event-page.dc.html) — carrying logo→`/`, top-nav [Эфиры · Мои события], a theme toggle, and the avatar-icon→profile (logged-in) / «Войти» (guest); mobile collapses the nav into a `≡` dropdown. The avatar-icon→profile behaviour is per the owner clarification 2026-07-12.
