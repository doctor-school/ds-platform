...
None — the shell is fully designed in the vendored canvas: the persistent header is present across all portal canvases (logo→`/`, top-nav [Эфиры], theme toggle, and — signed in — the auth cluster (avatar-icon→profile plus «Мои события») / «Войти» for a guest), and mobile collapses the nav into a `≡` dropdown [Эфиры] plus the auth cluster.
...
- The **persistent app-shell header** is the vendored-canvas header present across **all** portal screens — [`design-source/account-my-events.dc.html`](../../../../../../design-source/account-my-events.dc.html), [`design-source/events-feed.dc.html`](../../../../../../design-source/events-feed.dc.html), [`design-source/event-page.dc.html`](../../../../../../design-source/event-page.dc.html) — carrying logo→`/`, top-nav [Эфиры], a theme toggle, and — signed in — the auth cluster (avatar-icon→profile plus «Мои события») / «Войти» (guest); mobile collapses the nav into a `≡` dropdown. The avatar-icon→profile behaviour is per the owner clarification 2026-07-12.
