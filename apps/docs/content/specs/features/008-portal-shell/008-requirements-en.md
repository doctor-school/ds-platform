...
| 7    | Playwright                                       | `apps/portal/e2e/shell/post-login-landing.spec.ts`    | Completing feature-003 login lands on `/` (discovery), not a scaffold. _[Amended 2026-08-17 — the landing is the visitor's return target, `/webinars` by default; this spec is re-pointed by the feature-013 EARS-15 Issue. See Amendment below.]_                                                                                                                                                            |
