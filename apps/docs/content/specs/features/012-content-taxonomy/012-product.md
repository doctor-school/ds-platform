...
- **US-8** — As a **content operator**, I re-create each of the sixteen legacy speaker rows by hand as an ordered event-to-expert link through the existing Expert form, so that no migration machinery, queue or guessed identity ever stands between the legacy row and its canonical Expert.
