...
The canvas [`design-source/event-page.dc.html`](../../../../../../design-source/event-page.dc.html) carries each fork, and **the canvas default is the working assumption, not the owner's pick**.

| #   | Fork                                                | Options (canvas)                                                                                                                                                                                                                                            | Canvas default                                        | Owner pick                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| --- | --------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| F-1 | Where the sign-up block lives on desktop            | **А** — pinned card on the right (conditions + «Участвовать» always visible while scrolling; strongest for conversion) · **Б** — in-flow block under the open part (base `webinar-page`) · **В** — in-flow plus a pinned narrow bar at the bottom on mobile | **none** — rendered as a side-by-side stand (`board`) | **А — pinned sign-up card on the right, as redrawn** — owner pick 2026-09-02, [#1562 comment 5505593537](https://github.com/doctor-school/ds-platform/issues/1562#issuecomment-5505593537); verbatim RU: «Мы с тобой чётко давно дорисовали в Claude Design макет - ты можешь посмотреть на дату создания макета - это и есть дата, когда мы его утвердили.» — i.e. the approval date is 2026-08-26, the creation date of the canvas [`design-source/archive/archive-event-page-variant-a.dc.html`](../../../../../../design-source/archive/archive-event-page-variant-a.dc.html) («Вебинар вариант А»). Layout: ONE right column per page holding the sticky sign-up card only, while the speaker card «Ведёт» sits in the LEFT flow and scrolls away. The redraw was the owner's condition on 2026-08-25 (verbatim RU: «Как это без макета понять? Может попросить доработать макет?») and resolved that objection |
| F-2 | How formats switch for a hybrid event               | **А** — choice at sign-up («очно / онлайн»), the page then shows only the chosen one · **Б** — two tabs inside the format block, switchable at any time                                                                                                     | **none** — side-by-side stand (`board`)               | **Б — two tabs** — owner pick 2026-08-25, interactive walkthrough; verbatim: «Б — две вкладки (Рекомендуется)»                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| F-3 | What happens when offline seats run out             | **А** — waiting list · **Б** — switch to online participation for hybrid, honest «мест нет» for pure offline · **В** — the «мест нет» state only                                                                                                            | **none** — side-by-side stand (`board`)               | **Б — switch hybrid to online, honest «мест нет» for pure offline** — owner pick 2026-08-25, interactive walkthrough; verbatim: «Б — гибриду онлайн (Рекомендуется)»; adds a small new requirement (the online-switch flow)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| F-4 | Where the partner-research mini-survey (REQ-135) go | **А** — right after the event rating, as one feedback block · **Б** — a separate later step in «Мои события», keeping the lecturer review apart from the advertising assessment                                                                             | **none** — side-by-side stand (`board`)               | **А — right after the rating** — owner pick 2026-08-25, interactive walkthrough; verbatim: «А — после оценки (Рекомендуется)»                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
Reused unchanged: the live room and chat [`unit-room-frame.dc.html`](../../../../../../design-source/unit-room-frame.dc.html) + [`unit-chat-column.dc.html`](../../../../../../design-source/unit-chat-column.dc.html) (entry only — the room is not re-drawn), the archive state [`event-page-recording.dc.html`](../../../../../../design-source/event-page-recording.dc.html), sign-in / registration [`auth.dc.html`](../../../../../../design-source/auth.dc.html) (returning to this page), and the expert card [`unit-expert-card.dc.html`](../../../../../../design-source/unit-expert-card.dc.html) in the speakers block. **New units defined here:** the **ticket / QR** (reused as-is by «Мои события» in `#d-lk`) and the **verification-status line** in its base form (its full anatomy is owned by `#d-lk`, which is drawn later; this page is aligned to it once that exists).
