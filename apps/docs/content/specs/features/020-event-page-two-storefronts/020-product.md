...
| --- | --------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| F-1 | Where the sign-up block lives on desktop            | **А** — pinned card on the right (conditions + «Участвовать» always visible while scrolling; strongest for conversion) · **Б** — in-flow block under the open part (base `webinar-page`) · **В** — in-flow plus a pinned narrow bar at the bottom on mobile | **none** — rendered as a side-by-side stand (`board`) | **А — pinned sign-up card on the right** — owner pick on the reworked mockup [#1562](https://github.com/doctor-school/ds-platform/issues/1562), drawn in full page context with the speaker card in the same right column ([`design-source/webinar-page-variant-a.dc.html`](../../../../../../design-source/webinar-page-variant-a.dc.html)); the rework was the owner's condition on 2026-08-25 (verbatim RU: «Я не понимаю, как будет выглядеть закреплённая справа карточка, когда на странице уже и так много всяких карточек. … Как это без макета понять? Может попросить доработать макет?») |
