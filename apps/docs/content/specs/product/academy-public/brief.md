...
- **The landing takes `/`** (supersedes the 2026-07-17 verdict that `/` redirects to `/webinars`). `/webinars` remains the canonical discovery listing, and **post-login landing stays `/webinars`** — the landing is an entry point for visitors, never a trap for authenticated users.
...
| 015 | `projects-catalog`                                               | `/projects` and the project page with its events, curator, experts, and partners.                                                                                                                                     |
| 016 | `experts-catalog`                                                | `/experts` and the expert page with their events and topics.                                                                                                                                                          |
