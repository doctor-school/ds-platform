...
- **A persistent app-shell header carries the account menu** across the portal. Logged-in shows **[Мои события · Профиль · Выйти]**; a guest shows **[Войти]**. This header is the spine that binds the shipped surfaces into one LK.
...
| #   | Feature                                                              | One-liner                                                                                                                                                                                                             |
| --- | -------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 008 | [`portal-shell`](../../features/008-portal-shell/008-product.md)     | A persistent app-shell header + account menu across the portal (logged-in: Мои события · Профиль · Выйти; guest: Войти) and `/` as the canonical public discovery front-door; retires the `/` scaffold.               |
