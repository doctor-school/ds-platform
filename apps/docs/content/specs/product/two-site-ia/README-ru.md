...
- Этап 3 (ниже), **часть 1 закрыта**: функциональная карта экран → REQ → фича — [`functional-map-ru.md`](./functional-map-ru.md) ([#1435](https://github.com/doctor-school/ds-platform/issues/1435)). 24 экрана R4 разложены на 27 предлагаемых фич (017…043) и 7 волн; REQ-1…142 покрыты без пропусков; 013 переспецифицируется как 029, 015 → 030, 016 → 031. **Ждём выбора владельцем волны 1** — рекомендация карты: 017+018+019+020+021 (витрина врача от входа до участия в событии). Часть 2 (бриф эпика, PRD фич, пакет промптов `design-prompts-ru/`) пишется после выбора.
