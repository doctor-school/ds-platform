...
- **The doctor's trace of the Academy is limited to two fixed placements** (REQ-24, NG-2) — the storefront footer link and «Стать экспертом» in the cabinet. The 028 documents list adds none: a caption exiting to the Academy documents page was drawn on `#d-docs` and is not built. The Academy never becomes a second doctor catalogue; the doctor storefront never exposes backstage.
