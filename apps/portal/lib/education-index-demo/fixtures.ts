...
export const news: readonly { organization: string; title: string }[] = [
  {
    ...
    title: "Ортелла Биотех вошла в тройку лидеров индекса",
  },
  {
    organization: "Карталис Фарма",
    title: "Карталис Фарма — первая четвёртую неделю подряд",
  },
  {
    organization: "Претона Биосистемс",
    title: "Претона Биосистемс поднялась на 6-е место",
  },
];
