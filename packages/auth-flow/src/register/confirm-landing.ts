...
/**
 * 021 EARS-10 (amended 2026-09-17) — WHERE A CONFIRMED VISITOR IS SENT.
 *
 ...
 * still lives in one pure function: «where does a confirmed visitor go» is the
 ...
 *   and the visitor lands where the door promised them they would.
 *
 ...
 * the email, so it is the one this door navigates to.
 */
