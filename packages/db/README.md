...
| `event_experts`             | soft-removable                                 | `status` + `deleted_at`                     | Relationship-shaped record (§3.6 rule 4): dropping a speaker from the line-up retires the link, preserving that this expert was announced for this broadcast. Since the 012 EARS-24 cutover it is the only speaker source.                                                                                                                                                 |
