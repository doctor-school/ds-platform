...
- Updated dependencies [[`1853c46`](https://github.com/doctor-school/ds-platform/commit/1853c46b619aa78d69e4da96c6d5e1a7a02d517d), [`096f73f`](https://github.com/doctor-school/ds-platform/commit/096f73ff412db2ac636cd04cb624209e7613da93), [`a4c37d2`](https://github.com/doctor-school/ds-platform/commit/a4c37d24812727cbfad64cd969446b0ee234848a), [`e26551d`](https://github.com/doctor-school/ds-platform/commit/e26551d777b683079f7dbed7f68e9ab8475a4508), [`7bb7040`](https://github.com/doctor-school/ds-platform/commit/7bb7040046f9ee2f2f4f0b3c007918bc9d2cba84), [`5912916`](https://github.com/doctor-school/ds-platform/commit/5912916deaab5efea847a94fada3f0ea232634b1)]:
  - @ds/schemas@6.1.0
...
- [#1582](https://github.com/doctor-school/ds-platform/pull/1582) [`de51447`](https://github.com/doctor-school/ds-platform/commit/de5144764860d6e3c009330d7ea4d667316be367) Thanks [@sidorovanthon](https://github.com/sidorovanthon)! - Add the admin block tier to `@ds/design-system`: `data-table` (two-line record rows on desktop, stacked record cards under 768px, optional whole-row activation with an owner-approved `tint-pressed` state), `filter-bar` (instant/debounced apply with removable chips), `combobox` (closed RU vocabulary with per-option explanations), the form section family (`FormSection`/`FormFieldGroup`/`FormSeparator`/`FormActions`/`FormDerivedNote`), `pagination` (numbered pages) and `empty-state` (no-data vs no-results variants). All adopted from the committable registry whitelist and re-skinned to tokens.
