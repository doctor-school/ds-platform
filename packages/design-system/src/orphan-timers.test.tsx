 ...
 * `input-otp@1.5.0` clears its own timers, so no upstream defect is tolerated. The
...
describe("#441 orphan-timer tracking (vitest.setup.ts)", () => {
  ...
  it("#441: input-otp@1.5.0 clears its own syncTimeouts — unmount leaves no orphan", async () => {
