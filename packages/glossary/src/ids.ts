...
export const GLOSSARY_TERMS: readonly GlossaryTerm[] = [
  ...
  { id: "event_lifecycle_state", title: "event lifecycle state", description: "The single closed state machine (draft → published → live → ended → hidden) that is the one source of truth every webinar surface reads.", boundedContext: "webinars", lang: "en" },
  ...
  { id: "presence_heartbeat", title: "presence heartbeat", description: "The server-authoritative signal posted immediately on visible entry/re-entry and every N seconds thereafter — each accepted beat appended to durable Postgres.", boundedContext: "webinars", lang: "en" },
  { id: "presence_minutes", title: "presence minutes", description: "Per-doctor heartbeat-covered minutes derived from append-only beats — the sponsor deliverable, concurrent-tab-coalesced and parameterized over N.", boundedContext: "webinars", lang: "en" },
