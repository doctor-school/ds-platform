 ...
 * `@ds/auth-flow/server` (the ONE host-side declaration since #2027) and
 * `apps/portal/lib/registration-state.ts` each declare a shape of these three
 * headers with their own doc contracts, and both satisfy this one structurally. Lifting it into `@ds/schemas` was rejected
