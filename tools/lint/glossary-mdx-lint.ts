 ...
 * Re-entry criterion (promote to BLOCK + back into the needs-list): the glossary
 * generation pipeline (ADR-0006 §6.2) landed with #460 and the §6.4
 * directive-marker collision was settled by the ADR-0006 §6 reconcile (#459), so
 * the remaining conditions are real `[[term-id]]` usage landing AND the Pilot
 * phase opening — earliest sweep 2026-07-02 per ADR-0007 §2.6 + ADR-0006 §7.0.
 *
