 ...
 * dir by runGuard) points the `apps/docs/content/**\/*.md` frontmatter scan at a
 * fixture tree. Reproduces the #596 failure class — an unquoted `: ` inside a
...
describe("frontmatter-yaml", () => {
  it("green: well-formed frontmatter (the `: ` entry is quoted) → exit 0", () => {
